...
AS $$
DECLARE
  project_url TEXT := 'https://lswqvfricrmbhqcerofe.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imxzd3F2ZnJpY3JtYmhxY2Vyb2ZlIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2MTY2OTAyNiwiZXhwIjoyMDc3MjQ1MDI2fQ.pKmjKWt8qYURkK00zFC-g1sGRhUJAdvJ3q4AXiqiMCc'; -- full access needed for http request to storage
